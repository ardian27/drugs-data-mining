...
/**
 * DataPreprosessingSearch represents the model behind the search form about `app\models\DataPreprosessing`.
 */
class DataPreprosessingSearch extends DataPreprosessing
{
    /**
     * @inheritdoc
     */
