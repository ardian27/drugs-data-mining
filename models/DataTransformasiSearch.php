...
/**
 * DataTransformasiSearch represents the model behind the search form about `app\models\DataTransformasi`.
 */
class DataTransformasiSearch extends DataTransformasi
{
    /**
     * @inheritdoc
     */
