...
<div class="data-awal-form">

    <?php $form = ActiveForm::begin(); ?>

    <?= $form->field($model, 'tgl_kematian')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'waktu_kematian')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'penyebab_kematian')->textInput(['maxlength' => true]) ?>
